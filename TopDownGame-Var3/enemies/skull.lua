sprites.skull = love.graphics.newImage('sprites/greenSkull.png') -- adds the zombie sprite
skulls = {} -- create global zombies table. function spawnZombie() creates and adds zombies to this table.

function skullsUpdate(dt)
--[[
        Documenting Logic
...
--[[
    ...
    for i,z in ipairs(skulls) do
        love.graphics.draw(sprites.skull, z.x, z.y, zombiePlayerAngle(z), nil, nil, sprites.skull:getWidth()/2, sprites.skull:getHeight()/2 ) -- draws zombies, "z" == individual zombie.
    end
end